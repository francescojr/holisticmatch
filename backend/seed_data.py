"""
Seed script to populate database with sample professionals
...
for data in professionals_data:
    ...
    print(f"✓ Created: {professional.name} - {', '.join(professional.services[:2])} - {professional.city}/{professional.state}")

print(f"\n✓ Successfully created {Professional.objects.count()} professionals!")
print("\nYou can now view them at:")
print("  - API: http://127.0.0.1:8000/api/v1/professionals/")
